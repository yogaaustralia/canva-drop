...
## Step 6b. Two lanes into Canva, and which one to pick

The connector never accepts a local file. When the thing to deliver already exists on disk, a finished PowerPoint or an image, there are two ways in and they reach different accounts.
